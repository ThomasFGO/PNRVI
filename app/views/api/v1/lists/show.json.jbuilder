...
if @list.occi?
  ...
  json.ref_cards @list.ref_cards do |ref_card|
    ...
    json.url cl_image_path ("lists/visuals/#{@list.bloc.cl_name}/#{@list.code}/#{ref_card.rank}")
  end
else
  ...
  json.ref_cards @list.ref_cards.order(:rank) do |ref_card|
    ...
    json.name ref_card.right_name
    json.pokedex_number ref_card.pokedex_number
    json.url cl_image_path ("jap_lists/visuals/#{@list.bloc.cl_name}/#{@list.code}/#{ref_card.rank}")
  end
end
